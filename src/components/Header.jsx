import nodeImg from "../assets/images/notes.png"
        ...
        <>
            ...
            <div>
                <form className="flex items-center bg-gray-100 px-4 py-4 rounded-md">
                    <img src={nodeImg} className="w-6 h-6" alt="Add todo" />
                    ...
                    <button type="submit" className={`appearance-none w-8 h-8 bg-[url('${plusImg}')] bg-no-repeat bg-contain`} />
                </form>
